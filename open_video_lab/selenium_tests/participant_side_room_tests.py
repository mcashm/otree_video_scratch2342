...
class TestParticipantSideRoomBehaviour(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.driver, cls.window_handles = create_session()
        time.sleep(15)
    ...
    def setUp(self):
        ...
        self.assertTrue(feature_tests_general.is_in_breakout_room(self.driver))

    def test_in_breakout_room(self):
        self.assertTrue(feature_tests_general.is_in_breakout_room(self.driver))

    def test_cam_not_disabled(self):
        self.assertTrue(feature_tests_general.video_usable(self.driver))

    def test_mic_button_not_disabled(self):
        self.assertTrue(feature_tests_general.audio_usable(self.driver))

    def test_mic_toggle_works(self):
        initial_mute_state = feature_tests_general.audio_muted(self.driver)
        ...
        self.assertTrue(initial_mute_state != feature_tests_general.audio_muted(self.driver))

    def test_cam_not_muted(self):
        self.assertFalse(feature_tests_general.video_muted(self.driver))
